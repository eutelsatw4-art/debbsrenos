...
export default function QuoteForm() {
  ...
  const formEmail = contact.formEmail || 'info@debbsrenos.com'
  const quoteSubject = contact.quoteSubject || 'New Quote Request'
  ...
  return (
    <section className="quote-section" id="quote">
      ...
      <form className="quote-form" action={`https://formsubmit.co/${formEmail}`} method="POST">
        ...
        <input type="hidden" name="_subject" value={quoteSubject} />
